...
public class ProjetoILexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PROGRAM", "INTEGER", "BOOLEAN", "STRING", "BEGIN", "END", "WHILE", "FOR", 
			"TO", "DO", "READ", "VAR", "FALSE", "TRUE", "WRITE", "IF", "THEN", "ELSE", 
			"OR", "AND", "OPREL", "OPMOE", "OPDIF", "OPEQ", "OPAD", "OPSUB", "OPMULT", 
			"OPDI", "OPNEG", "ATRIB", "PVIG", "PONTO", "DPONTOS", "VIG", "ABPAR", 
			"FPAR", "ABCHAVE", "FCHAVE", "CTE", "CADEIA", "ID", "COMMENT", "WS", 
			"ERRO", "LETRA", "DIGITO", "A", "B", "D", "E", "F", "G", "H", "I", "L", 

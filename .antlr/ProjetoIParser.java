...
public class ProjetoIParser extends Parser {
	...
	public final CmdCompContext cmdComp() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 17179894432L) != 0)) {
				{
				setState(84);
				listCmd();
				}
	...
	public static class ExprAddContext extends ParserRuleContext {
		...
		public List<TerminalNode> OPSU() { return getTokens(ProjetoIParser.OPSU); }
		public TerminalNode OPSU(int i) {
			return getToken(ProjetoIParser.OPSU, i);
		}
	...
	public static class ExprUnaryContext extends ParserRuleContext {
		...
		public TerminalNode OPSU() { return getToken(ProjetoIParser.OPSU, 0); }
